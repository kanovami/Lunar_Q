...
#==============================
figure = corner.corner(df[burnin::2,4:9],
    labels = [r"$\rho_{\rm{m}}\; \left[\rm{kg\; m^{-3}}\right]$", 
              r"$\rho_{\rm{c}}\; \left[\rm{kg\; m^{-3}}\right]$", 
              r"$R_{\rm{c}}\; \left[\rm{km}\right]$",
              r"$\rho_{\rm{LVZ}}\; \left[\rm{kg\; m^{-3}}\right]$", 
              r"$R_{\rm{LVZ}}\; \left[\rm{km}\right]$"],
    smooth=True,
    color='indianred',
    quantiles=[0.16, 0.5, 0.84],
    show_titles=True,
...
#================================
# Plot molten layer's properties
#================================
figure = corner.corner(df[burnin::2,7:],
    labels = [r"$\rho_{\rm{LVZ}}\; \left[\rm{kg\; m^{-3}}\right]$", 
              r"$R_{\rm{LVZ}}\; \left[\rm{km}\right]$", 
              r"$\log\;\eta_{\rm{LVZ}}\; \left[\rm{Pa\; s}\right]$", 
              r"$\mu_{\rm{LVZ}}\; \left[\rm{GPa}\right]$"],
    smooth=True,
    color='indianred',
    quantiles=[0.16, 0.5, 0.84],
    show_titles=True,
