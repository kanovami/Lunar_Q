...
!===============================================
SUBROUTINE peltier(j,freq,kj,hj,Qm)
USE mtype
USE mconst
IMPLICIT NONE
!-----------------------------------------------
...
REAL(DP),INTENT(OUT)     :: Qm    ! seismic Q of the mantle
