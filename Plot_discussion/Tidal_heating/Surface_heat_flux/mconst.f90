...
INTEGER, PARAMETER  :: ngl_rad=128  ! # of abscissae for Gauss-Legendre quadrature
...
CHARACTER(LEN=*),PARAMETER :: filein='rheo_melt.in'

! Tidal heating calculation
INTEGER, PARAMETER  :: nph=180,nth=90
INTEGER, PARAMETER  :: ntime=100
INTEGER, PARAMETER  :: nr=10 ! # of layers for radially dependent heating computation
